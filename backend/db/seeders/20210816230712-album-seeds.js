...
module.exports = {
  up: (queryInterface, Sequelize) => {
    ...
    [
      { name: "Bangers Only", artistId: 1, albumImgUrl: "https://i.imgur.com/tfiI26M.jpg", createdAt: new Date(), updatedAt: new Date() },
      { name: "Trucks", artistId: 2, albumImgUrl: "https://i.imgur.com/tfiI26M.jpg", createdAt: new Date(), updatedAt: new Date() },
      { name: "Mr Ryan's Wild Ride", albumImgUrl: "https://i.imgur.com/tfiI26M.jpg", artistId: 3, createdAt: new Date(), updatedAt: new Date() },
