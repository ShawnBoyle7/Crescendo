...
module.exports = {
    up: (queryInterface, Sequelize) => {
        ...
        [
            ...
            { name: "American Idiot", artistId: 5, imgUrl: "https://crescendo-bucket.s3.us-west-1.amazonaws.com/album-art/album+art/american+idiot+art.jpg", releaseDate: 1965, songCount: 14, albumDuration: "35 min 32 sec", createdAt: new Date(), updatedAt: new Date() },
            { name: "Willy And The Poor Boys", artistId: 5, imgUrl: "https://crescendo-bucket.s3.us-west-1.amazonaws.com/album-art/album+art/willy+and+the+poor+boys+art.jpg", releaseDate: 1965, songCount: 14, albumDuration: "35 min 32 sec", createdAt: new Date(), updatedAt: new Date() },
            { name: "Animals", artistId: 5, imgUrl: "https://crescendo-bucket.s3.us-west-1.amazonaws.com/album-art/album+art/animals+art.jpg", releaseDate: 1965, songCount: 14, albumDuration: "35 min 32 sec", createdAt: new Date(), updatedAt: new Date() },
            { name: "Hybrid Theory", artistId: 5, imgUrl: "https://crescendo-bucket.s3.us-west-1.amazonaws.com/album-art/album+art/hybrid+theory+art.jpg", releaseDate: 1965, songCount: 14, albumDuration: "35 min 32 sec", createdAt: new Date(), updatedAt: new Date() }
        ])
    },
